...
public class Case_GapInReports extends BaseTest {
    ...
    /**
     * @see net.simforge.networkview.flights.processors.eventbased.criteria.TrackTrailCriterion
     * @see net.simforge.networkview.flights.processors.eventbased.criteria.EllipseCriterion
     */
