...
CREATE TABLE flt_pilot_status (
                                  id                       integer DEFAULT nextval('flt_pilot_status_id_seq'::regclass) NOT NULL
                                      CONSTRAINT pk_flt_pilot_status PRIMARY KEY,
...
(
    id           integer DEFAULT nextval('flt_event_id_seq'::regclass) NOT NULL
        CONSTRAINT pk_flt_event PRIMARY KEY,
    version      smallint                                              NOT NULL,
